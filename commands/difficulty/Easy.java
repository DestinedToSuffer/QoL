...
public class Easy implements CommandExecutor {

    private QoL plugin;

    public Easy(QoL plugin){
        this.plugin = plugin;
        plugin.getCommand("easy").setExecutor(this);
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if(!(sender instanceof Player)) {
            ...
            if(p.hasPermission("easy.use")){
                utils.difficulty(p, Difficulty.EASY);
